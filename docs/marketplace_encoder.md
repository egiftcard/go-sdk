...
### func \(\*MarketplaceEncoder\) [ApproveBuyoutListing](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/marketplace_encoder.go#L122-L128>)
...
### func \(\*MarketplaceEncoder\) [ApproveCreateListing](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/marketplace_encoder.go#L260>)
...
### func \(\*MarketplaceEncoder\) [BuyoutListing](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/marketplace_encoder.go#L186-L192>)
...
### func \(\*MarketplaceEncoder\) [CancelListing](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/marketplace_encoder.go#L83>)
...
### func \(\*MarketplaceEncoder\) [CreateListing](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/marketplace_encoder.go#L305>)
...
## type [MarketplaceFilter](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/types.go#L529-L534>)
...
## type [MerkleContent](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/snapshots.go#L35-L37>)

```go
type MerkleContent struct {}
```

### func \(MerkleContent\) [CalculateHash](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/snapshots.go#L39>)

```go
func (t MerkleContent) CalculateHash() ([]byte, error)
```

### func \(MerkleContent\) [Equals](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/snapshots.go#L48>)

```go
func (t MerkleContent) Equals(other merkletree.Content) (bool, error)
```

## type [MerkleNode](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/sharded_merkle_tree.go#L263-L265>)

```go
type MerkleNode struct {}
```

### func \(\*MerkleNode\) [Serialize](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/sharded_merkle_tree.go#L267>)

```go
func (t *MerkleNode) Serialize() ([]byte, error)
```

## type [Metadata](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/types.go#L19-L22>)

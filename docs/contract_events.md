...
contract.Events.GetEvents("Transfer", egiftcard.EventQueryOptions{
  FromBlock: 100000000,
  ToBlock:   100000001,
})

// And setup a listener to listen for future Transfer events
contract.Events.AddEventListener("Transfer", func (event egiftcard.ContractEvent) {
  fmt.Printf("%#v\n", event)
})
```
...
### func \(\*ContractEvents\) [AddEventListener](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/contract_events.go#L94>)
...
listener := func (event egiftcard.ContractEvent) {
  fmt.Printf("%#v\n", event)
}
...
### func \(\*ContractEvents\) [GetEvents](<https://github.com/egiftcard/go-sdk/blob/main/egiftcard/contract_events.go#L174>)
...
queryOptions := egiftcard.EventQueryOptions{

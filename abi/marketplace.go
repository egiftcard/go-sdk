...
func (_Marketplace *MarketplaceCaller) EgiftcardFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Marketplace.contract.Call(opts, &out, "egiftcardFee")
...
//
// Solidity: function egiftcardFee() view returns(address)
func (_Marketplace *MarketplaceSession) EgiftcardFee() (common.Address, error) {
	return _Marketplace.Contract.EgiftcardFee(&_Marketplace.CallOpts)
}

// EgiftcardFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function egiftcardFee() view returns(address)
func (_Marketplace *MarketplaceCallerSession) EgiftcardFee() (common.Address, error) {
	return _Marketplace.Contract.EgiftcardFee(&_Marketplace.CallOpts)
}

...
// EgiftcardFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function egiftcardFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Caller) EgiftcardFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC1155.contract.Call(opts, &out, "egiftcardFee")
...
//
// Solidity: function egiftcardFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Session) EgiftcardFee() (common.Address, error) {
	return _TokenERC1155.Contract.EgiftcardFee(&_TokenERC1155.CallOpts)
}

// EgiftcardFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function egiftcardFee() view returns(address)
func (_TokenERC1155 *TokenERC1155CallerSession) EgiftcardFee() (common.Address, error) {
	return _TokenERC1155.Contract.EgiftcardFee(&_TokenERC1155.CallOpts)
}

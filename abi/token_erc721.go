...
func (_TokenERC721 *TokenERC721Caller) EgiftcardFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC721.contract.Call(opts, &out, "egiftcardFee")
...
//
// Solidity: function egiftcardFee() view returns(address)
func (_TokenERC721 *TokenERC721Session) EgiftcardFee() (common.Address, error) {
	return _TokenERC721.Contract.EgiftcardFee(&_TokenERC721.CallOpts)
}

// EgiftcardFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function egiftcardFee() view returns(address)
func (_TokenERC721 *TokenERC721CallerSession) EgiftcardFee() (common.Address, error) {
	return _TokenERC721.Contract.EgiftcardFee(&_TokenERC721.CallOpts)
}

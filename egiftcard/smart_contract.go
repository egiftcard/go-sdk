...
// Custom Contracts
//
// With the egiftcard SDK, you can get a contract instance for any contract. Additionally,
// if you deployed your contract using egiftcard deploy, you can get a more explicit and
...
// deployed using the egiftcard deploy flow:
//
//	import (
...
//
// Alternatively, if you didn't deploy your contract with egiftcard deploy, you can still get a
